...
| `KIMI_CODE_ENGINE` | Select the agent engine for interactive sessions; `v2` runs them on the in-process agent-core-v2 engine (experimental) | `v2`; any other value keeps the default v1 engine |
