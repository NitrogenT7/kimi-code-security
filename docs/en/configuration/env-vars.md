...
| `KIMI_CODE_ENGINE` | Select the agent engine for interactive sessions; the v2 engine (in-process agent-core-v2) is the default | `v1` falls back to the legacy v1 engine |
